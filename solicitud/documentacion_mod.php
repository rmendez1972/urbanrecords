...
<div class="tituSec">Modificar datos Solicitud de Constancia</div>
 ...
 <table width="95%" align="center" class="tablaDatos">
   ...
   <tr >
     ...
     <td class="segundalinea" ><textarea name="observaciones" cols="70" rows="3" onblur="javascript:this.value=this.value.toUpperCase()"><?PHP  echo $datos['observaciones'] ?>
     </textarea></td>
   </tr>
 </table>
 <br />
 ...
 <table width="50%" border="0" align="center" cellpadding="0" cellspacing="0" >
   <tr>
     <td align="center"><img src="../images/continuar1.png" onmouseover="" class="btnOld" alt="Capturar solicitantes" onclick="envia()" /></td>
     <td align="center"><img src="../images/cancelar1.png" class="btnOld" alt="Ir a inicio" onclick="location.href='../solicitud/seleccionarS.php<?PHP echo "?backing=1&id_solicitud=".$_GET['id_solicitud']."&anio=".$_GET['anio']; ?>'" /></td>
   </tr>
 </table>
