...
<?PHP 
if (isset($_POST['restaurar']) && $_POST['restaurar']=='OK'){
		...
		$consulta= "UPDATE solicitud SET estado=0 WHERE id_solicitud=".$_POST['id_solicitud']." AND anio=".$_POST['anio'];
...
<script language="javascript">
	...
	window.location='seleccionarS.php?backing=1&id_solicitud=<?php echo $_POST["id_solicitud"] ?>&anio=<?php echo $_POST["anio"]; ?>';
...
var aceptar=confirm("¿Está seguro que desea restaurar?");

if (aceptar){
	document.forms.formulario.restaurar.value="OK";
	return true ;
...
<div class="tituSec">Restaurar Solicitud de Constancia</div>
 <table width="95%" align="center" class="tablaDatos">
   ...
   <tr >
     ...
     <td class="segundalinea" ><?PHP  echo $datos['id_solicitud']."/".$datos['abreviatura']."/".$datos['anio']; ?>
       <img src="../images/b_edit.png" alt="Modificar datos solicitud" width="16" height="16" border="0" onclick="location.replace('editar.php<?PHP  echo "?id_solicitud=".$datos['id_solicitud']."&anio=".$datos['anio']; ?>')" /></td>
   </tr>
   <tr >
 ...
 <br />
 <input name="restaurar" type="hidden" />
 ...
 <table width="50%" border="0" align="center" cellpadding="0" cellspacing="0" >
   <tr>
     <td align="center"><input type="image" src="../images/restaurar1.png" style="border:0 hidden " alt="Restaurar solicitud" onclick='return confirmar()'/></td>
