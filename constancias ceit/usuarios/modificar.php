		    ...
		    <td align="center"><br>
              ...
              <table width="90%" class="tabla2">
                ...
                <tr >
                  ...
                  <td class="segundalinea"  ><input type="text"  name="nombre" size="70" value="<?PHP  echo $datos_usuario['nombre'] ?>"  maxlength="140" onblur="javascript:this.value=this.value.toUpperCase()">
					</td>
                ...
                <tr >
                  ...
                  <select name="tipo" size="1" onChange="verifica();"> 
