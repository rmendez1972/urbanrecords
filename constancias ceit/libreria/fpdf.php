...
var $widths;			 //Ancho de las celdas que recibe la funcion para las multiceldas continuas
var $alinea;			 //Alineacion de las celdas del multicell
var $salto;			 //Alineacion de las celdas del multicell
var $borde;			 //1 dibuja el borde, 0 sin borde


//Recibe el ancho de las multicell y la alineaci&oacute;n
...
//Recibe la informaci&oacute;n de las celdas
function Row($data,$relleno)
{
	...
	for($i=0;$i<count($data);$i++)
	{
		...
		if ($nb>1){
			...
			$this->MultiCell($w,$h/$nb,$data[$i],$this->borde,$lado,$relleno[$i]);
		}
		else{
			//Asigna el alto de la fila mas alto ($h)
			$this->MultiCell($w,$h,$data[$i],$this->borde,$lado,$relleno[$i]);
		}
...
function FPDF($orientation='P',$unit='mm',$format='A4')
{
	...
	if(is_string($format))
	{
		...
		elseif($format=='card')
			$format=array(584,394);
		elseif($format=='legal')
			$format=array(612,967);
		else
