...
// Este archivo se utiliza en las páginas que se abren en el frame principal

// Aqu&iacute; se establecen los valores de configuraci&oacute;n que se utilizan en las páginas.
...
$UsrMysql='constanciausr'; 

$ClaveMysql='c0n5t4nc1@';
