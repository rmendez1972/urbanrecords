...
?>
        <tr >
            ...
            <td class="segundalinea" >  <textarea name="<?PHP  echo "proyecto".$pregunta['id_pregunta']; ?>" cols="50" rows="2" onblur="javascript:this.value=this.value.toUpperCase()"></textarea>            </td>
            <td class="segundalinea" >  <textarea name="<?PHP  echo "pdu".$pregunta['id_pregunta']; ?>" cols="50" rows="2" onblur="javascript:this.value=this.value.toUpperCase()"></textarea>            </td>
            <td class="segundalinea" >  <textarea name="<?PHP  echo "cumple".$pregunta['id_pregunta']; ?>" cols="20" rows="2" onblur="javascript:this.value=this.value.toUpperCase()"></textarea>            </td>
          </tr>
<?PHP 					} //fin while
...
<br />
  ...
  <input name="Visualizar" type="button" value="Visualizar" id="visualizar" style="display:block" onclick="activa();" />
...
<br />
		...
		<table width="95%" > 
          ...
          <tr > 
              <td height="28" align="center"  class="segundalinea"><textarea name="observaciones" cols="150" rows="2" onblur="javascript:this.value=this.value.toUpperCase()"></textarea></td>
          </tr>
		</table>
<br />
